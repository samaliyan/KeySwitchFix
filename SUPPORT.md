...
1. Install the latest KeySwitchFix release.
2. Confirm **Protection is active** and **Keyboard hook: Running**.
3. Test in Windows Notepad to separate application-specific behavior from global behavior.
